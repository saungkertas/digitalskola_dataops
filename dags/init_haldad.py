...
with DAG('init_haldad',
    ...
    data_definition_orders = BashOperator(
        ...
        bash_command="""bq mkdef --autodetect --source_format=CSV gs://digitalskola-de-batch7/haldad/staging/orders/* > /root/table_def/haldad/orders.def"""
    )

    to_dwh_orders = BashOperator(
        task_id='to_dwh_orders',
        bash_command="""bq mk --external_table_definition=/root/table_def/haldad/orders.def de_7.haldad_orders"""
    )
