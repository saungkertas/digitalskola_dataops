...
conn = None
sql = """select * from order_details where order_id in (select order_id fr
om orders where order_date='"""+sys.argv[1]+"""')"""
csv_file_path = '/root/output/sari/order_details/order_details'+sys.argv[1
]+'.csv'
