...
sql = """select product_id, product_name, supplier_id, category_id, quantity_per_unit, unit_price from products """
csv_file_path = '/root/output/madeadi/products/products_'+sys.argv[1]+'.csv'
