...
conn = None
sql = """select supplier_id, company_name, contact_name, contact_title, address,
city, region, postal_code, country, phone, fax, homepage from suppliers"""
csv_file_path = '/root/output/isbah/suppliers/suppliers_'+sys.argv[1]+'.csv'
