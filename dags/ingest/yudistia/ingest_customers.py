...
conn = None
sql = """select customer_id, company_name, contact_name, contact_title, address, city,region, postal_code, country, phone, fax from customers"""
csv_file_path = '/root/output/yudistia/customers/customers_'+sys.argv[1]+'.csv'
